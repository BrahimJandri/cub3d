...
SRC = ./library/get_next_line/get_next_line.c ./library/get_next_line/get_next_line_utils.c \
	...
	./parsing/fill_map1.c ./parsing/flood_fill.c main.c ./parsing/free_func.c \
	./parsing/parse_color.c ./parsing/parse_texture.c ./parsing/utils.c render.c move.c generate_walls.c 
OBJ = $(SRC:.c=.o)
